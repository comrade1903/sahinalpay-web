...
export const milliyetColumnSeeds: ArchiveItemSeed[] = [
  ...
  },
  {
    ...
    excerpt:
      "KKTC muhalefet lideri, Cumhuriyetçi Türk Partisi başkanı Mehmet Ali Talat ile Rauf Denktaş'ın Kıbrıs'ta dolaylı görüşmelerden çekilme kararı üzerine söyleşi; Talat, çözüm istediklerini ama Denktaş ve Ankara'nın federasyonla Kıbrıs Türklüğünün 'mahvolacağı' korkusuyla hareket ettiğini, çözümsüzlüğün adayı 1974 öncesine döndürme riski taşıdığını anlatıyor.",
    sourceNote: "Şahin Alpay'ın kişisel arşivinden, Entellektüel Bakış sayfasından kupür.",
